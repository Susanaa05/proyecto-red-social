...
function SearchFunction() {
    ...
    const handleSelect = (place: string) => {
        navigate("/searchPage", { state: { selectedPlace: place } });
    };

    return (
        <div className=" bg-black text-white p-5 flex flex-col rounded-lg">
            <button onClick={() => navigate("/searchPage")} className="mt-4 text-sm text-gray-400 hover:text-purple-500 mb-5"><X /></button>
